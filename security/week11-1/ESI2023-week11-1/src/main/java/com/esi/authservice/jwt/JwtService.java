...
public class JwtService {
    ...
    // jwt has three components, all of them are called claims
    // We need to store these three compoennts in a format that allows us to deal with them properly, and that is why we are using HashMap()
